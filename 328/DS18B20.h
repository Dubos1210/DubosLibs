...
#ifndef DUBOS_DS18B20
#define DUBOS_DS18B20
...
/****************************************
 * Функция	 : Reset-импульс
 * Ответ	 : 0xFF, если датчик ответил
			   0x00 в остальных случаях
 ****************************************/
...
int DS18B20_temperature(void) {
  ...
  if (DS18B20_init() > 0) {
    ...
    ds18b20temperature *= 5;
    ds18b20temperature /= 8;
  }
